# Sprecher-Skript · ISO/IEC 25010:2023 Kompendium

Companion-Datei zur Vortrags-Skript-Box im Footer von `tools/iso-25010-kompendium.html` (K16). Bei
Abweichung gilt die Footer-Box im HTML als Quelle; diese Datei wird bei der nächsten inhaltlichen
Änderung synchronisiert.

## Einsatzdauer

Ca. 15–20 Minuten als Norm-Einführung, z. B. zu Beginn eines RE-Trainingsblocks zu nicht-funktionalen
Anforderungen.

## Ablauf

**(1) Grundlagen** *(Hero vorlesen, dann auf die drei Grundlagen-Karten zeigen)*

„Bevor wir über neun Qualitätsmerkmale sprechen, kurz drei Begriffe: eine funktionale Anforderung sagt,
was ein System tun soll. Eine nicht-funktionale sagt, wie gut. Und eine User Story macht beides für ein
Team greifbar – mit einem Akzeptanzkriterium, das man tatsächlich testen kann."
...
*(Klick auf Merkmal 1 „Functional Suitability")*
